            ...
            <div className="flex">
              ...
              <div className="ml-3 flex-1 md:flex md:justify-between">
                <p className="text-sm text-blue-700">
                  <strong>Admin setup:</strong> If you're setting up this app for the first time, please visit <Link href="/firebase-account-check"><span className="font-medium underline">Firebase Account Setup</span></Link> to create the initial administrator account.
                </p>
              </div>
            </div>
          </div>
